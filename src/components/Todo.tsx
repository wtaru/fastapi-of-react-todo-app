...
import { useQueryTasks } from '../hooks/newQueryTasks'
    ...
    return (
        <div className='flex justify-center items-center flex-col min-h-screen text-gray-500 font-mono'>
            ...
            <form onSubmit={processTask}>
                {/* title */}
                <input
                    className='mb-3 mr-3 px-3 py-2 border boder-gray-300' 
                    type="text" 
                    placeholder='title ?'
                    onChange={(e) => 
                ...
                />
                <button 
                    className='disabled:opacity-40 mx-3 py-2 px-3 text-white bg-teal-600 rounded'
            ...
            <h2 className='mt-3 font-bold'>Seleted Task</h2>
